...
//		poly.addTerm(new Term(0, BigInteger.ONE));
//                poly.addTerm(new Term(2, BigInteger.TEN));
//                poly.addTerm(new Term(3, new BigInteger("3")));
	...
	private static void testEval_1()
	{
		...
		p1.addTermLast(new Term(2, new BigInteger("2")));
                p1.addTermLast(new Term(1, new BigInteger("0")));
		p1.addTermLast(new Term(0, new BigInteger("1")));
			
                System.out.println(p1.eval(new BigInteger("2")));
